...
export const races: Race[] = [
  ...
  { id: "japan-2026",       round:  3, name: "Japanese Grand Prix",              country: "Japan",                 date: "2026-03-29", status: "upcoming", flag: "🇯🇵" },
...
export const driverInfo: DriverInfo[] = [
  ...
  { name: "Arvid Lindblad", number: 17, team: "Racing Bulls", teamColor: "#6692FF" },
  { name: "Pierre Gasly", number: 10, team: "Alpine", teamColor: "#FF87BC" },
  { name: "Franco Colapinto", number: 43, team: "Alpine", teamColor: "#FF87BC" },
  { name: "Sergio Perez", number: 11, team: "Cadillac", teamColor: "#7A7A7A" },
  { name: "Valtteri Bottas", number: 77, team: "Cadillac", teamColor: "#7A7A7A" },
];
